...
const xumm = new XummPkce('9f999e04-4dd0-4060-a0a9-a359e664e0ea', {
...
const connectGemWallet = async () => {
  try {
    const clientSession = await client.connectKitToWallet(null, "9f999e04-4dd0-4060-a0a9-a359e664e0ea");
...
const login = async () => {
  try {
    ...
    console.log('XUMM authorize payload:', payload);

    const userInfo = await xumm.user();
    console.log('XUMM user info:', userInfo);
